...
public class SetupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabaseSetup= FirebaseDatabase.getInstance().getReference().child("Organisers");
        ...
        mSetupCollege=(EditText)findViewById(R.id.setupCollege);
        mSetupCity=(EditText)findViewById(R.id.setupCity);
        mSetupState=(EditText)findViewById(R.id.setupState);
        mSetupButton=(Button)findViewById(R.id.setupButton);
        mSetupImageButton=(ImageButton) findViewById(R.id.setupImage);
        ...
        if(!TextUtils.isEmpty(name)&&mImageUri != null)
        {
            ...
            filepath.putFile(mImageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    mProgress.dismiss();
                    Toast.makeText(SetupActivity.this,"Update Successful !!",Toast.LENGTH_LONG).show();
            ...
            filepath.putFile(mImageUri).addOnFailureListener(new OnFailureListener() {
                ...
                public void onFailure(@NonNull Exception e) {
                    mProgress.dismiss();
                    Toast.makeText(SetupActivity.this,"Uploading Failed!",Toast.LENGTH_SHORT).show();
                }
            });
