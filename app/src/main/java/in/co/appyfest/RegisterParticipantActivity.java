...
public class RegisterParticipantActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRegUsername=(EditText)findViewById(R.id.addParticipantUsername);
        mRegEmail=(EditText)findViewById(R.id.addParticipantEmail);
        mRegPassword=(EditText)findViewById(R.id.addParticipantPassword);
        mRegCity=(EditText)findViewById(R.id.addParticipantCity);
        mRegCollege=(EditText)findViewById(R.id.addParticipantCollege);
        mRegState=(EditText)findViewById(R.id.addParticipantState);
        mRegPartSubmit=(Button)findViewById(R.id.participantSubmit);
        mRegIcon=(ImageButton)findViewById(R.id.addParticipantClgeIcon);
        ...
        mRegPartSubmit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startRegister();
            }
    ...
    private void startRegister() {
        ...
        if(!TextUtils.isEmpty(name)&&!TextUtils.isEmpty(email)&&!TextUtils.isEmpty(password)&&!TextUtils.isEmpty(college)&&!TextUtils.isEmpty(city)&&!TextUtils.isEmpty(state)){
                    ...
                    mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(RegisterParticipantActivity.this, "Registration Successful!!", Toast.LENGTH_SHORT).show();
                                cleartext();
                                mProgress.dismiss();


                                Intent intent = new Intent(RegisterParticipantActivity.this, LoginParticipantActivity.class);
                                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                                startActivity(intent);


                            } else {
                                Toast.makeText(RegisterParticipantActivity.this, "Error!!", Toast.LENGTH_SHORT).show();
                                mProgress.dismiss();
                            }
                        }
                    });
